...
public class RideHistoryActivity extends AppCompatActivity {
    ...
    public void onStart() {
        ...
        try {
            ...
            mPassengerID = extras.getString("user");
        } catch (Exception e) {
        }

        if ((mPassengerID != null) && !mPassengerID.isEmpty()) {
            mRidesQuery = FirebaseDatabase.getInstance().getReference().child("rides").orderByChild("passengerId").equalTo(mPassengerID);
